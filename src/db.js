...
exports.CompanyOverview = mongoose.model('CompanyOverview',
    new mongoose.Schema({
        symbol: {
            type: String,
...
exports.DailyAdjusted = mongoose.model('DailyAdjusted', dailyAdjusteds);
...
exports.TechnicalIndicators = mongoose.model('TechnicalIndicators', technicalIndicators);
...
vixs.index({ date: -1 });
exports.VIXs = mongoose.model('VIXs', vixs);
